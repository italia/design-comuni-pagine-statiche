...
const ROUTES_IT = [
  ...
  baseUrl + "area-personale.html",
  baseUrl + "documenti.html",
  baseUrl + "perfezionare-richiesta.html",
  baseUrl + "effettuare-pagamento.html",
  baseUrl + "ztl-dati-servizio.html",
  baseUrl + "trovare-informazioni-servizio-disservizio.html",
  baseUrl + "acconsentire-trattamento-dati-inseriti-disservizio.html",
  baseUrl + "inserire-dati-specifici-disservizio.html",
  baseUrl + "conferma-riepilogo-informazioni-inserite-disservizio.html",
  baseUrl + "finalizzare-procedura-disservizio.html",
  baseUrl + "segnalazione-disservizio.html",
  baseUrl + "disservizio-lista.html",
  baseUrl + "inserire-dati-specifici-appuntamento.html",
  baseUrl + "inserire-dati-specifici-appuntamento-2.html",
  baseUrl + "inserire-dati-specifici-appuntamento-step-2.html",
  baseUrl + "inserire-dati-specifici-appuntamento-step-3.html",
  baseUrl + "controllare-dati-personali-appuntamento.html",
  baseUrl + "controllare-dati-personali-appuntamento-2.html",
  baseUrl + "finalizzare-procedura-pagamento.html",
  baseUrl + "template-tutti-servizi.html",
  baseUrl + "sito-pubblico-pagina-amministrazione.html",
  baseUrl + "sito-pubblico-pagina-vivi.html",
  baseUrl + "iscrizione-modali.html",
];
const ROUTES_EN = [
  /*  
